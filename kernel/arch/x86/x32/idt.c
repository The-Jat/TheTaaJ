...
{
LogInformation("IDT", "IdtInitialize, Initializing the IDT");
...
void InterruptInstallDefaultGates(void)
{
	LogInformation("IDT", "InterruptInstallDefaultGates, Installing the Interrupt Gates");
	...
	LogInformation("IDT", "InterruptInstallDefaultGates, Interrupt Gates Installed");
}
